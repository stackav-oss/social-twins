...
class CausalSceneTokens(BaseModel):
    ...
    This model is similar to `SceneTokens` but adds a head for classifying causal agents in the scene.
    """

    def __init__(self, config: DictConfig) -> None:
        """Initialize the CausalSceneTokens model.
        ...
        # Agent causality classifier and tokenizer
    ...
    def forward(self, batch: dict) -> ModelOutput:
        ...
        Returns:
            ModelOutput: model outputs containing scenario embeddings, trajectory decoder outputs, tokenization outputs,
                causal outputs, ground-truth tensors, metadata, and optional scores.
        """
