...
from scenetokens.analysis.scenario_visualizers.visualizer import BaseVisualizer
from scenetokens.analysis.scenario_visualizers.waymo_causal import WaymoCausalVisualizer
...
class WaymoCausalAnimatedVisualizer(WaymoCausalVisualizer, BaseVisualizer):
    ...
    def visualize_scenario(
        ...
        WaymoCausalVisualizer visualizes the scenario on three or four windows:
